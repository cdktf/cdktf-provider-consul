...
export class DataConsulServiceHealth extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataConsulServiceHealth that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/consul/2.20.0/docs/data-sources/service_health#import import section} in the documentation of this resource for the id to use
