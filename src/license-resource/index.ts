// https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs/resources/license
...
export class LicenseResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LicenseResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs/resources/license#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs/resources/license consul_license} Resource
  *
  * @param scope The scope in which to define this construct
