// https://registry.terraform.io/providers/hashicorp/consul/2.19.0/docs/resources/key_prefix
...
export class KeyPrefix extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KeyPrefix that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/consul/2.19.0/docs/resources/key_prefix#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/consul/2.19.0/docs/resources/key_prefix consul_key_prefix} Resource
  *
  * @param scope The scope in which to define this construct
