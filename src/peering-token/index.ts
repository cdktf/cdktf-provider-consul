...
// https://registry.terraform.io/providers/hashicorp/consul/2.22.0/docs/resources/peering_token
...
export class PeeringToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PeeringToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/consul/2.22.0/docs/resources/peering_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/consul/2.22.0/docs/resources/peering_token consul_peering_token} Resource
  *
  * @param scope The scope in which to define this construct
