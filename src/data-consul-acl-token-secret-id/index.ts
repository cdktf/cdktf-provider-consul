...
// https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs/data-sources/acl_token_secret_id
...
export class DataConsulAclTokenSecretId extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataConsulAclTokenSecretId that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs/data-sources/acl_token_secret_id#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs/data-sources/acl_token_secret_id consul_acl_token_secret_id} Data Source
  *
  * @param scope The scope in which to define this construct
