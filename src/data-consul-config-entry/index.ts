...
// https://registry.terraform.io/providers/hashicorp/consul/2.22.1/docs/data-sources/config_entry
...
export class DataConsulConfigEntry extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataConsulConfigEntry that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/consul/2.22.1/docs/data-sources/config_entry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/consul/2.22.1/docs/data-sources/config_entry consul_config_entry} Data Source
  *
  * @param scope The scope in which to define this construct
