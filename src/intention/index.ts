...
// https://registry.terraform.io/providers/hashicorp/consul/2.22.0/docs/resources/intention
...
export class Intention extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Intention that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/consul/2.22.0/docs/resources/intention#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/consul/2.22.0/docs/resources/intention consul_intention} Resource
  *
  * @param scope The scope in which to define this construct
