// https://registry.terraform.io/providers/hashicorp/consul/2.19.0/docs/data-sources/acl_auth_method
...
export class DataConsulAclAuthMethod extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataConsulAclAuthMethod that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/consul/2.19.0/docs/data-sources/acl_auth_method#import import section} in the documentation of this resource for the id to use
