...
// https://registry.terraform.io/providers/hashicorp/consul/2.19.0/docs/data-sources/acl_policy
...
export class DataConsulAclPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataConsulAclPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/consul/2.19.0/docs/data-sources/acl_policy#import import section} in the documentation of this resource for the id to use
