// https://registry.terraform.io/providers/hashicorp/consul/2.20.0/docs/resources/autopilot_config
...
export class AutopilotConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AutopilotConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/consul/2.20.0/docs/resources/autopilot_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/consul/2.20.0/docs/resources/autopilot_config consul_autopilot_config} Resource
  *
  * @param scope The scope in which to define this construct
