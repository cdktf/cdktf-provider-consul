// https://registry.terraform.io/providers/hashicorp/consul/2.19.0/docs/resources/namespace_policy_attachment
...
export class NamespacePolicyAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NamespacePolicyAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/consul/2.19.0/docs/resources/namespace_policy_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/consul/2.19.0/docs/resources/namespace_policy_attachment consul_namespace_policy_attachment} Resource
  *
  * @param scope The scope in which to define this construct
