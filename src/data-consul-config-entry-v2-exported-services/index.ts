// https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs/data-sources/config_entry_v2_exported_services
...
export interface DataConsulConfigEntryV2ExportedServicesConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class DataConsulConfigEntryV2ExportedServices extends cdktf.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataConsulConfigEntryV2ExportedServices to import
  * @param importFromId The id of the existing DataConsulConfigEntryV2ExportedServices that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs/data-sources/config_entry_v2_exported_services#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs/data-sources/config_entry_v2_exported_services consul_config_entry_v2_exported_services} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataConsulConfigEntryV2ExportedServicesConfig
  */
  public constructor(scope: Construct, id: string, config: DataConsulConfigEntryV2ExportedServicesConfig) {
    super(scope, id, {
