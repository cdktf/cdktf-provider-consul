...
// https://registry.terraform.io/providers/hashicorp/consul/2.22.0/docs
...
export class ConsulProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing ConsulProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/consul/2.22.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/consul/2.22.0/docs consul} Resource
  *
  * @param scope The scope in which to define this construct
