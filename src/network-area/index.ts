...
// https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs/resources/network_area
...
export class NetworkArea extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkArea that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs/resources/network_area#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs/resources/network_area consul_network_area} Resource
  *
  * @param scope The scope in which to define this construct
