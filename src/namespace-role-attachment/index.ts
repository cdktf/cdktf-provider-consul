...
// https://registry.terraform.io/providers/hashicorp/consul/2.22.0/docs/resources/namespace_role_attachment
...
export class NamespaceRoleAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NamespaceRoleAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/consul/2.22.0/docs/resources/namespace_role_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/consul/2.22.0/docs/resources/namespace_role_attachment consul_namespace_role_attachment} Resource
  *
  * @param scope The scope in which to define this construct
