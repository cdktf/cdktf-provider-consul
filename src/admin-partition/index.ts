...
// https://registry.terraform.io/providers/hashicorp/consul/2.22.1/docs/resources/admin_partition
...
export class AdminPartition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AdminPartition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/consul/2.22.1/docs/resources/admin_partition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/consul/2.22.1/docs/resources/admin_partition consul_admin_partition} Resource
  *
  * @param scope The scope in which to define this construct
