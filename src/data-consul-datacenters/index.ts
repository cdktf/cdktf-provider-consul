...
// https://registry.terraform.io/providers/hashicorp/consul/2.22.0/docs/data-sources/datacenters
...
export class DataConsulDatacenters extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataConsulDatacenters that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/consul/2.22.0/docs/data-sources/datacenters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/consul/2.22.0/docs/data-sources/datacenters consul_datacenters} Data Source
  *
  * @param scope The scope in which to define this construct
