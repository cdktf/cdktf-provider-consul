...
```go
import "github.com/cdktf/cdktf-provider-consul-go/consul/v10/aclbindingrule"
...
&aclbindingrule.AclBindingRuleConfig {
	...
	BindName: *string,
	BindType: *string,
	BindVars: github.com/cdktf/cdktf-provider-consul-go/consul/v10.aclBindingRule.AclBindingRuleBindVars,
	Description: *string,
	Id: *string,
	Namespace: *string,
	Partition: *string,
...
| <code><a href="#@cdktf/provider-consul.aclBindingRule.AclBindingRuleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.22.0/docs/resources/acl_binding_rule#id AclBindingRule#id}. |
