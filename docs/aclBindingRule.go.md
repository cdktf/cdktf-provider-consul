...
```go
import "github.com/cdktf/cdktf-provider-consul-go/consul/v9/aclbindingrule"
...
&aclbindingrule.AclBindingRuleConfig {
	...
	BindName: *string,
	BindType: *string,
	BindVars: github.com/cdktf/cdktf-provider-consul-go/consul/v9.aclBindingRule.AclBindingRuleBindVars,
	Description: *string,
	Id: *string,
	Namespace: *string,
	Partition: *string,
