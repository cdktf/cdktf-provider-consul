...
```go
import "github.com/cdktf/cdktf-provider-consul-go/consul/v9/certificateauthority"
...
| <code><a href="#@cdktf/provider-consul.certificateAuthority.CertificateAuthorityConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs/resources/certificate_authority#id CertificateAuthority#id}. |
