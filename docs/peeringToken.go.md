...
```go
import "github.com/cdktf/cdktf-provider-consul-go/consul/v10/peeringtoken"
...
```go
func ResetServerExternalAddresses()
```
...
```go
func ServerExternalAddressesInput() *[]*string
```
...
```go
func ServerExternalAddresses() *[]*string
```
