...
```go
import "github.com/cdktf/cdktf-provider-consul-go/consul/v9/adminpartition"
...
| <code><a href="#@cdktf/provider-consul.adminPartition.AdminPartitionConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.20.0/docs/resources/admin_partition#id AdminPartition#id}. |
