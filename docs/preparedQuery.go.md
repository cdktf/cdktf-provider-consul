...
```go
import "github.com/cdktf/cdktf-provider-consul-go/consul/v7/preparedquery"
...
&preparedquery.PreparedQueryConfig {
	...
	Connect: interface{},
	Datacenter: *string,
	Dns: github.com/cdktf/cdktf-provider-consul-go/consul/v7.preparedQuery.PreparedQueryDns,
	Failover: github.com/cdktf/cdktf-provider-consul-go/consul/v7.preparedQuery.PreparedQueryFailover,
	Id: *string,
	...
	StoredToken: *string,
	Tags: *[]*string,
	Template: github.com/cdktf/cdktf-provider-consul-go/consul/v7.preparedQuery.PreparedQueryTemplate,
	Token: *string,
}
```
